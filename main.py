...
def create_parser():
    ...
    parser.add_argument('--ex_name', default='typhoon', type=str)
    ...
    parser.add_argument('--dataname', default='typhoon_attention', choices=['typhoon_attention'])
    parser.add_argument('--num_workers', default=8, type=int)

    # model parameters
    parser.add_argument('--in_shape', default=[5, 1, 128, 128], type=int, nargs='*') # [10, 1, 64, 64] for mmnist, [4, 2, 32, 32] for taxibj
