...
def load_fixed_set(root):
    ...
    filename = '/home/fw/AIMB/Lu/data/typhoon/images_seq.npy'
    # filename = 'typhoon/images_seq.npy'
    path = os.path.join(root, filename)
    path = '../data/typhoon/images_seq.npy'
...
class TyphoonDataset(data.Dataset):
    def __init__(self, root, is_train=True, n_frames_input=5, n_frames_output=5, num_objects=[2],
                 transform=None):
...
def load_data(
    ...
    # (20,10000,64,64,1)
    train_set = TyphoonDataset(root=data_root, is_train=False,
                            n_frames_input=5, n_frames_output=5, num_objects=[2])
    # (20,10000,64,64,1)
    test_set = TyphoonDataset(root=data_root, is_train=False,
                           n_frames_input=5, n_frames_output=5, num_objects=[2])
