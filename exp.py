...
class Exp:
    ...
    def _preparation(self):
        ...
        # log and checkpoint, ./results/typhoon
    ...
    def _save(self, name=''):
        torch.save(self.model.state_dict(), os.path.join(self.checkpoints_path, name + '.pth'))
    ...
    def test(self, args):
        ...
        for batch_x, batch_y in self.test_loader:
            ...
            # for tensor, lst in zip([batch_x, batch_y, pred_y], [inputs_lst, trues_lst, preds_lst]):
            #     lst.append(tensor.detach().cpu().numpy())
